...
INSTALLED_APPS = [
    ...
    'cookiejar.apps.CookiejarConfig',
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'assets')]  # for CSS, fonts, JavaScript, etc.

MEDIA_URL = 'media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'uploads')  # to save uploaded images, data, etc.
